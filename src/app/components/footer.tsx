...
export default function Footer() {
	return (
		<div className='absolute bottom-0 bg-zinc-800 bg-opacity-40 w-screen p-3 px-5 font-funnelSans z-50'>
			...
			<span className='absolute bottom-2 left-5 text-neutral-500 text-sm'>
